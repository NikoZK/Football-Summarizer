            ...
            <div class="preview-card mb-4">
                ...
                <div class="row">
                    <div class="col-md-6 text-center">
                        ...
                        <p class="mb-1"><strong>Form (Last 5):</strong> <span class="form-badges">${formatFormBadges(homeForm.lastFiveGames)}</span></p>
                    ...
                    <div class="col-md-6 text-center border-start">
                        ...
                        <p class="mb-1"><strong>Form (Last 5):</strong> <span class="form-badges">${formatFormBadges(awayForm.lastFiveGames)}</span></p>
